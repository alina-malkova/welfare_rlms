...
\begin{tabular}{llcc}
\toprule
Analysis & Method & $\delta^-$ Estimate & Conclusion \\
\midrule
R1 & Partial identification & $\lambda \in [1.5, 2.9]$ & Loss aversion confirmed \\
R2 & Quantile regression & 0.06--0.09 & Robust across distribution \\
R3 & Selection correction & 0.063--0.070 & Not driven by selection \\
